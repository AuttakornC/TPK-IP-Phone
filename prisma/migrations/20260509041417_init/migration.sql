...
-- CreateIndex
CREATE UNIQUE INDEX "zones_project_id_code_key" ON "zones"("project_id", "code");

-- CreateIndex
CREATE INDEX "speakers_project_id_idx" ON "speakers"("project_id");

-- CreateIndex
CREATE INDEX "speakers_zone_id_idx" ON "speakers"("zone_id");
...
-- AddForeignKey
ALTER TABLE "speakers" ADD CONSTRAINT "speakers_zone_id_fkey" FOREIGN KEY ("zone_id") REFERENCES "zones"("id") ON DELETE SET NULL ON UPDATE CASCADE;
